...
const AdminHeader = ({toggleSidebar, sidebarOpen}) => {
    ...
    return (
        <nav className = 'navbar navbar-expand-lg navbar-light bg-white border-bottom px-3 shadow-sm'>
            ...
            <span className = 'navbar-brand fw-semibold'><i className='fa fa-utensils me-2'></i>Food Ordering System</span>
            ...
            <div className = 'collapse navbar-collapse'>
                <ul className = 'navbar-nav ms-auto align-items-center gap-2'>
                    ...
                    <li className = 'nav-item'>
                        <button onClick = {handleLogout} className = 'btn btn-outline-danger'><FaSignOutAlt className = 'me-1'/>Logout</button>
                    </li>
                </ul>
            </div>
        </nav>
